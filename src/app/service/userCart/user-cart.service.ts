...
export class UserCartService {
  ...
  private deleteCartItemUrl="http://localhost:9081/api/usercart/deleteusercart";
  ...
  deleteCartItem(userId: number, sku: string) {
    const finalUrl = `${this.deleteCartItemUrl}?userId=${userId}&sku=${sku}`;
